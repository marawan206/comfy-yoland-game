...
const SCRIPT = {
  old: {
    ...
    hotspots: [
      ...
      { id: 'duck', asset: 'plush_duck_yellow_hat_1x1', label: 'The duck', memory: true, lines: [
        ...
        L(Y, 'It’s coming with us. Non-negotiable.') ] },
  ...
  new: {
    title: '201 Spear St, STE 1700', objective: (n, t, done) => done.has('doors') ? `Explore the floor: ${n}/${t}  •  Find your desk` : 'Check in at the oak doors',
    intro: [
      ...
      L(Y, 'Let’s look around. My desk is somewhere in the open area.'),
    ],
    hotspots: [
      ...
      { id: 'meeting', asset: 'conference_table_5x2', label: 'The glass meeting room', lines: [
        ...
        L(Y, 'The old office had a TV balanced on top of the fridge. We’ve come a long way.') ] },
      { id: 'kitchen', asset: 'kitchen_island_curved_3x1', label: 'The kitchen', lines: [
        L(Y, 'A real kitchen. A fridge that closes. A microwave that doesn’t trip the breaker.'),
